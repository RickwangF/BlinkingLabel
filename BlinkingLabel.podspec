...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'Just Blinking UILabel'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'Add Blinking Function to UILabel'
  s.homepage         = 'https://github.com/RickwangF/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'woshiwwy16@126.com' => 'woshiwwy16@126.com' }
  s.source           = { :git => 'https://github.com/RickwangF/BlinkingLabel.git', :tag => '0.1.0'}
